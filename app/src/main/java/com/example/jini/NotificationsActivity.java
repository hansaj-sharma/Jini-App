...
public class NotificationsActivity extends AppCompatActivity {
    ...
    private DatabaseReference contactsRef, friendRequestRef, userRef;
                                                                                                                    ...
                                                                                                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                                                                                        ...
                                                                                                                        public void onComplete(@NonNull Task<Void> task) {
                                                                                                                            if (task.isSuccessful()) {
                                                                                                                                ...
                                                                                                                                Toast.makeText(NotificationsActivity.this, "Friend Request Accepted and Contact Saved", Toast.LENGTH_SHORT).show();
    ...
    public static class NotificationViewHolder extends RecyclerView.ViewHolder {
        ...
        public NotificationViewHolder(@NonNull View itemView) {
            super(itemView);
            userNameTxt= itemView.findViewById(R.id.username_notification);
